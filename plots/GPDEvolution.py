...
ax1.plot(data[:,0], data[:,2],  label = r"\textbf{$\xi=0$}",    color = "red")
ax1.plot(data[:,0], data[:,4],  label = r"\textbf{$\xi=0.05$}", color = "orange")
ax1.plot(data[:,0], data[:,8],  label = r"\textbf{$\xi=0.5$}",  color = "magenta")
ax1.plot(data[:,0], data[:,11], label = r"\textbf{$\xi=1$}",    color = "brown")
ax1.legend(fontsize = 18)
...
ax2.plot(data[:,0], data[:,2]  / data[:,1], color = "red")
ax2.plot(data[:,0], data[:,4]  / data[:,1], color = "orange")
ax2.plot(data[:,0], data[:,8]  / data[:,1], color = "magenta")
ax2.plot(data[:,0], data[:,11] / data[:,1], color = "brown")
...
xi = np.linspace(0, 1, 100)
plt.plot(xi, p1(xi), 'r--', lw = 1.5, label = r"\textbf{Fit with $f(\xi)=A_0+ A_1\xi^2$}")
plt.plot(xi, p3(xi), 'b--', lw = 1.5, label = r"\textbf{Fit with $f(\xi)=A_0+A_1\xi^2+A_2\xi^4$}")
